import { CrownOutlined, LogoutOutlined, ShopOutlined } from "@ant-design/icons";
...
// brand (see ../theme.ts) - a visual cue that this is the Velora platform
...
const NAV_ITEMS = [{ key: "/platform-admin/tenants", icon: <ShopOutlined />, label: "Tenants" }];
      ...
      <Sider width={232} style={{ background: PLATFORM_INK, display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "20px 20px" }}>
          ...
          <div style={{ lineHeight: 1.1 }}>
            <div style={{ color: "#fff", fontWeight: 700, fontSize: 16, letterSpacing: 0.2 }}>Velora</div>
